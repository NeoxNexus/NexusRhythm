...
如果你想先理解这套节奏，而不是直接安装，建议按这个顺序读：

1. [docs/GUIDE.md](docs/GUIDE.md) 的“先看系统架构总览”
2. [docs/GUIDE.md](docs/GUIDE.md) 的“30 分钟最小学习路径”
3. 再回到本 README 继续看安装和命令速查

如果你希望的是“我不想先学全套概念，只想让 AI 带我做项目”，也先看 `docs/GUIDE.md` 新增的这两节。它们专门解释了这套系统应该如何降低理解负担，而不是把概念负担转嫁给使用者。
